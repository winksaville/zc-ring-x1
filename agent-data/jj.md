...
Each repo contains a `.vc-config.md` whose toml blocks hold a `[repos]` registry that records
the workspace layout. Values are ordinary paths relative to the config file's directory (absolute allowed,
